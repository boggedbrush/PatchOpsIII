# PatchOpsIII v1.1.1 (Test) Release Notes

This is a test-only build of PatchOpsIII v1.1.1, intended solely to exercise the updater flow. Do not treat this as a production release.
...
- **Test build notice:** This build is for updater testing only and not intended for general use.

---

## 📥 Download the Latest Release
- [Download PatchOpsIII v1.1.1-Test for Windows]({{WINDOWS_DOWNLOAD_URL}})
- [Download PatchOpsIII v1.1.1-Test for Linux & Steam Deck]({{LINUX_DOWNLOAD_URL}})
